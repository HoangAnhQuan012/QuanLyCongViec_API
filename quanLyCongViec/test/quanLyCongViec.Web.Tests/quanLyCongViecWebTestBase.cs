...
{
    public abstract class quanLyCongViecWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static quanLyCongViecWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(quanLyCongViecWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<quanLyCongViecDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<quanLyCongViecDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<quanLyCongViecDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<quanLyCongViecDbContext, Task<T>> func)
        {
            T result;
